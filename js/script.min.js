...
function update(chosenLocation) {
  ...
  function drawBetweenLines(lineData, settings) {
    ...
    update.enter().append("path").attr("d", d => settings.lineFunction(d.lineData)).attr("stroke-width", 0).attr("fill", "none").transition(t).attr("stroke", d => d.target.color).attr("stroke-width", d => settings.lineWidthRange(+d.target.weight) + "px");
    // .merge(lines);
